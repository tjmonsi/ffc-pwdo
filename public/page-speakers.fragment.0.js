...
var _gestureEventListeners = __webpack_require__(89);
...
var _templatize = __webpack_require__(97);

var _debounce = __webpack_require__(17);

var _flush = __webpack_require__(99);
...
var host = 'https://raw.githubusercontent.com/tjmonsi/ffc-pwdo/master';

var FetchMixin = exports.FetchMixin = function FetchMixin(superClass) {
  return function (_superClass) {
    ...
    _createClass(_class, [{
      ...
      value: function getHost() {
        return _window.location.host.indexOf('localhost') === 0 ? '' : host;
      }
    }, {
      key: 'fetch',
      value: function fetch(path) {
        var url = _window.location.host.indexOf('localhost') === 0 ? path : host + path;

        return (0, _window.fetch)(url).then(function (result) {
          return path.indexOf('.md') < 0 ? result.json() : result.text();
        });
        // add catch
      }
    }]);
...
var _fetchMixin = __webpack_require__(113);
...
var Component = function (_FetchMixin) {
  _inherits(Component, _FetchMixin);
  ...
  _createClass(Component, [{
    ...
    value: function _fetchSpeaker(speakerId) {
      ...
      if (speakerId) {
        this.fetch('/data/speakers/' + speakerId + '.json').then(function (speaker) {
          return _this2.speaker = Object.assign({}, _this2.speaker, speaker);
        });

        this.fetch('/data/speakers/' + speakerId + '.md').then(function (bio) {
    ...
    value: function _fetchSession(sessionId) {
      ...
      if (sessionId) {
        this.fetch('/data/sessions/' + sessionId + '.json').then(function (session) {
  ...
  return Component;
}((0, _fetchMixin.FetchMixin)((0, _gestureEventListeners.GestureEventListeners)(_polymerElement.Element)));
...
module.exports = "<img class=\"avatar\" src=\"[[getHost()]]/data/speakers/[[speakerId]].jpg\">\n\n<section class=\"speaker\">\n  <h3 class=\"speaker-name\">\n    [[speaker.name]]\n  </h3>\n  <p class=\"speaker-position\">\n    [[speaker.position]]\n  </p>\n  <p class=\"speaker-bio\">\n    [[speaker.bio]]\n  </p>\n  <a class=\"speaker-talk\">\n    [[session.title]]\n  </a>\n</section>"
...
var Component = function (_FetchMixin) {
  ...
  _createClass(Component, [{
    ...
    value: function connectedCallback() {
      ...
      _get(Component.prototype.__proto__ || Object.getPrototypeOf(Component.prototype), 'connectedCallback', this).call(this);
      this.fetch('/data/speakers.json').then(function (json) {
        return _this2.speakersList = json;
      });
    }
  }], [{
    key: 'is',
...
var _mutableData = __webpack_require__(98);
